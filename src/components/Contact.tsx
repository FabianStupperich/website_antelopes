      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="bg-gray-50 p-4 sm:p-6 rounded">
            <h3 className="text-base font-bold text-gray-900 mb-3 sm:mb-4">{t.contact.contactInfo}</h3>
            <div className="space-y-3 sm:space-y-4 text-sm">
              <div>
                <h4 className="font-semibold text-gray-900 mb-1 text-sm">{t.contact.chair}</h4>
                <h4 className="text-gray-900 mb-1 text-sm">{t.contact.center}</h4>
                <h4 className="text-gray-900 mb-1 text-sm">{t.contact.university}</h4> <br />
                <h4 className="font-semibold text-gray-900 mb-1 text-sm">{t.contact.contactPerson}</h4>
               </div>
              <div>
