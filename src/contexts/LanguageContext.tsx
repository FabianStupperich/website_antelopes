...
const translations = {
  de: {
    ...
    'publications.kivi01.3.date': '2024',
    ...
    'publications.kivi01.5.date': '2021',
    ...
    'publications.kivi01.7.date': '2020'
  }, 
  en: {
    'nav.project': 'Project',
    ...
    'publications.kivi.01.subtitle': 'Publications from the predecessor project to the current project titled “KIVi - Artificial intelligence for assessing the security of electricity supply”, funded by the Federal Ministry XYZ in the period XYZ with funding code XYZ.',
    'publications.nr': 'No.',
