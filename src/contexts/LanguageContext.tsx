...
const translations = {
  de: {
    ...
    'project.challenge.content': 'Die Bewertung der Versorgungssicherheit mit Elektrizität wird durch die Energiewende zunehmend komplexer. Hochkomplexe Simulationsmodelle, die alle relevanten Systemkomponenten wie erneuerbare Energien, Speicher und Sektorenkopplung berücksichtigen, erfordern einen erheblichen Rechenaufwand für jede einzelne Szenarioberechnung. Diese ressourcenintensiven konventionellen Verfahren begrenzen die Anzahl untersuchbarer Szenarien drastisch und verhindern umfassende Analysen verschiedener Zukunftspfade. Um diese Einschränkungen zu überwinden, bedarf es neuer methodischer Ansätze. Gleichzeitig steigen die Anforderungen der europäischen Regulierungsbehörden an die Versorgungssicherheitsbewertung stetig - ein Dilemma zwischen Modellkomplexität und verfügbaren Rechenressourcen.',
    ...
    'publications.kivi01.1.title': 'KIVi - Künstliche Intelligenz zur Untersuchung der Versorgungssicherheit mit Elektrizität : Abschlussbericht',
    ...
    'publications.kivi01.3.title': 'Artificial intelligence and design of experiments for resource adequacy assessment in power systems, Energy Strategy Reviews, 53, 101368.',
    'publications.kivi01.3.authors': 'Priesmann, J., Münch, J., Tillmanns, M., Ridha, E., Spiegel, T., Reich, M., Adam, M., Nolting, L., Praktiknjo, A.',
    'publications.kivi01.3.date': 'May 2024',
    'publications.kivi01.4.title': 'The Potential of Deep Learning to Reduce Complexity in Energy System Modeling, International Journal of Energy Research.',
    'publications.kivi01.4.authors': 'Köhnen, C. S., Priesmann, J., Nolting, L., Kotzur, L., Robinius, M., Praktiknjo, A.',
    'publications.kivi01.4.date': 'November 2021',
    'publications.kivi01.5.title': 'The complexity dilemma – Insights from security of electricity supply assessments. Energy, 122522.',
    'publications.kivi01.5.authors': 'Nolting, L., Praktiknjo, A.',
    'publications.kivi01.5.date': 'February 2022',
    'publications.kivi01.6.title': 'How to Model European Electricity Load Profiles using Artificial Neural Networks, Applied Energy, 277, 115564.',
    'publications.kivi01.6.authors': 'Behm, C., Nolting, L., Praktiknjo, A.',
    'publications.kivi01.6.date': 'November 2020',
    'publications.kivi01.7.title': 'Can Energy System Modeling Benefit from Artificial Neural Networks? Application of Two-stage Metamodels to Reduce Computation of Security of Supply Assessments, Computers & Industrial Engineering, 142.',
    'publications.kivi01.7.authors': 'Nolting, L., Spiegel, T., Reich, M., Adam, M., Praktiknjo, A.',
    'publications.kivi01.7.date': 'April 2020'
  }, 
  en: {
    'nav.project': 'Project',
    ...
    'project.challenge.content': 'The energy transition is making it increasingly difficult to assess the security of electricity supply. Highly complex simulation models that take into account all relevant system components, such as renewable energies, storage, and sector coupling, require considerable computing power for each individual scenario calculation. These resource-intensive conventional methods drastically limit the number of scenarios that can be examined and prevent comprehensive analyses of different future paths. New methodological approaches are needed to overcome these limitations. At the same time, European regulatory authorities are constantly increasing their requirements for security of supply assessments - creating a dilemma between model complexity and available computing resources.',
    ...
    'project.goals.title': 'Project Objectives',
    ...
    'consortium.partner2.role': 'The Center for Innovative Energy Systems at HSD is leading the technical development and validation of the AI-based metamodels. With its expertise in machine learning and metamodeling, Zies develops customized solutions for the approximation of ERAA models. It tests various methodological approaches for partial or holistic approximation and integrates design of experiments and active learning algorithms into metamodeling.',
    ...
    'publications.kivi.01.subtitle': 'Publications from the predecessor research project to the current project titled “KIVi - Artificial intelligence for assessing the security of electricity supply”, funded by the German Federal Ministry for Economic Affairs and Climate Action (BMWK) in the period June 6, 2020 - November 30, 2023 with funding code 03EI1022A.',
    'publications.nr': 'No.',
